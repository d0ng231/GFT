...
def prepare_dataset(jsonl_path="/data/Finetune_v18_aug.json",
    ...
    supplement_info = ( "Here's the explanation with specific visual characteristics observed on OCTA images for healthy, NPDR, and PDR retinas:\n"

        "Healthy Retina \n"
        "* Vascular Structure: The image displays a dense and continuous network of small capillaries forming an intricate lattice-like pattern. The vessels are well-distributed and show no interruptions.\n"
